...
export const TICKER_HEADLINES = [
  '⚡ EXTRA! MindMap interactive full-stack knowledge platform shipped to live production on Render',
  '📈 MARKET UPDATE: $REACT, $NODEJS and $MONGODB hit peak full-stack architecture benchmark metrics',
  '☕ BREAKING: Engineer converts espresso into 5,000 lines of bug-free algorithm code',
  ...
  '💼 WANT AD ALERT: Leading tech research labs compete for top-tier Computer Science & AI talent',
];
...
export const FEATURED_PROJECTS: Article[] = [
  {
    ...
    caption: 'Fig 1. MindMap (MindLink) visual workspace for connecting thoughts and ideas.',
  ...
  {
    id: 'proj-ai-mind',
    title: 'INVESTIGATIVE REPORT: AI MIND MATRIX 3D NEURAL PLATFORM SHIPS TO 50K USERS',
    subtitle: 'High-Performance Visualizer Renders Real-Time LLM Thought Graphs in WebGL',
    category: 'Investigative',
    author: 'Science & AI Desk',
    date: 'August 14, 2026',
    readTime: '3 min read',
    summary: 'A revolutionary web application allowing developers and researchers to inspect high-dimensional vector spaces and multi-agent AI reasoning chains in real-time 3D.',
    content: [
      'The AI Mind Matrix project represents a breakthrough in artificial intelligence explainability. Built with React Three Fiber, WebGL shaders, and custom Web Workers, the application visualizes thousands of active token nodes simultaneously without dropping below 60 FPS.',
      'By decoupling complex graph computation from the main UI looper thread using dynamic offscreen canvas rendering, the system achieves unprecedented throughput while delivering interactive node manipulation.',
      'Key technical features include real-time audio reactivity, dynamic cluster analysis, exportable vector maps, and seamless integration with OpenAI and Anthropic API streams.',
    ],
    image: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=800&auto=format&fit=crop',
    caption: 'Fig 2. Real-time neural cluster visualization running inside the browser.',
    tags: ['React', 'Three.js', 'WebGL', 'TypeScript', 'AI/LLM', 'Web Workers'],
    metrics: [
      { label: 'FPS Target', value: '60 FPS' },
      { label: 'Node Capacity', value: '50,000+' },
      { label: 'Latency', value: '< 15ms' },
    ],
    demoUrl: 'https://github.com/rizwansalmani',
    githubUrl: 'https://github.com/rizwansalmani',
    architectureNotes: [
      'Implemented Web Workers to handle force-directed graph calculations off the main thread.',
      'Utilized GPU Instanced Mesh rendering to display 50k nodes in a single draw call.',
      'Built a custom Web Audio synthesizer to generate procedural ambient hum based on graph density.',
    ],
  },
  {
    id: 'proj-neural-lab',
    title: 'DATA SCIENCE SPECIAL: NEURAL DATA LAB ANALYTICS SUITE LAUNCHES',
    subtitle: 'Interactive Machine Learning Visualizer Simplifies Predictive Analytics and Vector Indexing',
    category: 'Tech & Science',
    author: 'Data Intelligence Desk',
    date: 'August 08, 2026',
    readTime: '4 min read',
    summary: 'An interactive laboratory environment that lets computer science students and data scientists experiment with model hyperparameters, clustering algorithms, and real-time loss surface plots.',
    content: [
      'Constructed as part of advanced computer science research into machine learning interpretability, Neural Data Lab renders 2D/3D decision boundaries and loss gradients dynamically.',
      'Using WebGL fragment shaders and Python FastAPI model endpoints, the platform processes complex dataset embeddings instantly.',
    ],
    image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=800&auto=format&fit=crop',
    caption: 'Fig 3. Interactive loss surface and clustering model graph.',
    tags: ['Python', 'PyTorch', 'Data Science', 'FastAPI', 'WebGL', 'TailwindCSS'],
    metrics: [
      { label: 'Accuracy Rate', value: '98.4%' },
      { label: 'Datasets Loaded', value: '120+' },
      { label: 'Latency', value: '12ms' },
    ],
    demoUrl: 'https://github.com/rizwansalmani',
    githubUrl: 'https://github.com/rizwansalmani',
    architectureNotes: [
      'Built custom Canvas 2D loss curve plotter with WebSockets live streaming.',
      'Integrated PyTorch model quantization for rapid browser execution.',
    ],
  },
  {
    id: 'proj-hyperflow',
    title: 'TECHNICAL INSIGHT: HYPERFLOW DISTRIBUTED EVENT ENGINE BREAKS BENCHMARKS',
    subtitle: 'Zero-Dependency Event Pipeline Handles 1M Messages Per Second with Sub-Millisecond Overhead',
    category: 'Tech & Science',
    author: 'Infrastructure Correspondent',
    date: 'July 28, 2026',
    readTime: '5 min read',
    summary: 'An open-source distributed event-driven workflow engine designed for micro-frontend applications and real-time collaborative platforms.',
    content: [
      'When state synchronization bottlenecks began plaguing complex web applications, Rizwan Salmani architected HyperFlow — a lightweight, zero-dependency event bus that bridges local client state with server-sent event streams.',
      'HyperFlow leverages modern JavaScript SharedArrayBuffer and atomic memory locks to achieve lock-free inter-thread communication, making it ideal for real-time multiplayer tools and live financial dashboards.',
      'The project has received over 2,500 GitHub stars and is currently adopted by over a dozen high-growth technology startups globally.',
    ],
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=800&auto=format&fit=crop',
    caption: 'Fig 4. Distributed server event pipeline architecture blueprint.',
    tags: ['Node.js', 'Distributed Systems', 'WebSockets', 'TypeScript', 'Redis'],
    metrics: [
      { label: 'Throughput', value: '1M msg/s' },
      { label: 'GitHub Stars', value: '2.5k+' },
      { label: 'Memory Footprint', value: '< 4MB' },
    ],
    demoUrl: 'https://github.com/rizwansalmani',
    githubUrl: 'https://github.com/rizwansalmani',
    architectureNotes: [
      'Constructed custom binary protocol parser for WebSocket payload compression.',
      'Engineered automatic fallback logic between WebSockets, WebRTC, and SSE streams.',
      'Comprehensive benchmark suite written in Vitest and K6.',
    ],
  },
];
...
export const CLASSIFIED_ADS: ClassifiedAd[] = [
  {
    ...
    title: 'FULL-TIME SOFTWARE & AI ENGINEER ROLES',
    priceTag: 'AVAILABLE NOW',
    description: 'Rizwan Salmani is actively available for Full-Time Software Engineer, AI Developer, and Full-Stack Lead roles. Mastery of React, TypeScript, Python, PyTorch, and LLM RAG architectures.',
  ...
  },
  {
    ...
    title: 'CS & DATA SCIENCE INTERNSHIP POSITIONS',
    priceTag: 'OPEN FOR OFFER',
    description: 'Seeking high-impact Computer Science, Data Science, and Machine Learning Internships. Ready to contribute production algorithm optimizations and scalable web systems.',
    contactEmail: 'rizwansalmani.dev@gmail.com',
    badge: 'OPEN TO OFFER',
  },
  {
    ...
    title: 'AI RESEARCH & OPEN-SOURCE COLLABORATIONS',
    priceTag: 'ACCEPTING TEAMS',
    description: 'Open to co-authoring open-source AI tools, research papers, vector RAG search libraries, and creative WebGL shader experiments with engineering teams.',
    contactEmail: 'rizwansalmani.dev@gmail.com',
    badge: 'COLLABORATE',
  },
  {
    ...
    description: 'Accepting select high-impact freelance projects, design system audits, web performance optimization, and principal engineering advisory engagements.',
    contactEmail: 'rizwansalmani.dev@gmail.com',
    badge: 'LIMITED SLOTS',
  },
];
